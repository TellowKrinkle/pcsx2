...
{
	EmuFolders::AppRoot = Path::Normalize(Path::GetDirectory(FileSystem::GetProgramPath()));
...
void QtHost::SetResourcesDirectory()
{
	...
	EmuFolders::Resources = Path::Normalize(Path::Combine(EmuFolders::AppRoot, "../Resources"));
#endif
}
