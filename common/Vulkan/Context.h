...
namespace Vulkan
{
	...
	public:
		...
		__fi const VkQueueFamilyProperties& GetGraphicsQueueProperties() const
		{
		...
		// Support bits
		__fi bool SupportsGeometryShaders() const { return m_device_features.geometryShader == VK_TRUE; }
		__fi bool SupportsDualSourceBlend() const { return m_device_features.dualSrcBlend == VK_TRUE; }
		...
		__fi VkDeviceSize GetMaxImageDimension2D() const
		{
