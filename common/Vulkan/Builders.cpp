...
namespace Vulkan
{
	...
	void GraphicsPipelineBuilder::SetStencilState(bool stencil_test, const VkStencilOpState& front, const VkStencilOpState& back)
	{
	...
	void DescriptorSetUpdateBuilder::AddImageDescriptorWrites(VkDescriptorSet set, u32 binding, const VkImageView* views,
	...
	void DescriptorSetUpdateBuilder::AddSamplerDescriptorWrites(VkDescriptorSet set, u32 binding, const VkSampler* samplers, u32 num_samplers)
	{
