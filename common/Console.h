...
struct IConsoleWriter
{
	...
	void(__concall* DoWriteFromStdout)(const char* fmt);

	void(__concall* Newline)();
	void(__concall* SetTitle)(const char* title);
