...
void Pcsx2App::DetectCpuAndUserMode()
{
	...
	if (!x86caps.hasStreamingSIMD2Extensions)
	{
		...
		throw Exception::RuntimeError()
			.SetDiagMsg("Critical Failure: SSE2 Extensions not available.")
			.SetUserMsg("SSE2 extensions are not available.  PCSX2 requires a cpu that supports the SSE2 instruction set.");
	}
#endif
