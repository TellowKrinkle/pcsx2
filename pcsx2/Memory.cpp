...
template<int vunum> static void TAKES_R64 vuMicroWrite64(u32 addr, r64 rdata) {
	u64 data = r64_to_u64(rdata);
	VURegs* vu = vunum ?  &VU1 :  &VU0;
	addr      &= vunum ? 0x3fff: 0xfff;
...
template<int vunum> static void TAKES_R64 vuDataWrite64(u32 addr, r64 rdata) {
	u64 data = r64_to_u64(rdata);
	VURegs* vu = vunum ?  &VU1 :  &VU0;
	addr      &= vunum ? 0x3fff: 0xfff;
	if (vunum && THREAD_VU1) {
