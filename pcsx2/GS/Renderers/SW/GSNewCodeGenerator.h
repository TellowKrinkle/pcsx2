...
struct CPUInfo
{
	...
	CPUInfo(const Xbyak::util::Cpu& cpu)
	{
		...
		if (cpu.has(cpu.tSSSE3))
			version = SSEVersion::SSSE3;
...
public:
	...
	const bool hasSSE2, hasSSE3, hasSSSE3, hasSSE41, hasAVX, hasAVX2, hasFMA;
	...
	GSNewCodeGenerator(Xbyak::CodeGenerator* actual, CPUInfo cpu)
		...
		, hasSSSE3(cpu.sseVersion >= SSEVersion::SSSE3)
